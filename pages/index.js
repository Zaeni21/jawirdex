...
async function connectWith(wallet) { if (!wallet) return alert("❌ Wallet tidak terdeteksi");
...
useEffect(() => { console.log("Wallets detected:", { ethereum: typeof window.ethereum !== "undefined", okxwallet: typeof window.okxwallet !== "undefined", }); }, []);
...
{!account && (
      <>
        {typeof window !== "undefined" && typeof window.ethereum !== "undefined" && (
          <button
            onClick={() => connectWith(window.ethereum)}
            className="w-full py-3 bg-cyan-600 hover:bg-cyan-500 rounded-xl font-semibold shadow-lg mb-4"
          >
            Connect MetaMask
          </button>
        )}
        {typeof window !== "undefined" && typeof window.okxwallet !== "undefined" && (
          <button
            onClick={() => connectWith(window.okxwallet)}
            className="w-full py-3 bg-orange-600 hover:bg-orange-500 rounded-xl font-semibold shadow-lg"
          >
            Connect OKX Wallet
          </button>
        )}
